            ...
            {editingBooking ? (
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className="px-3 py-2 rounded-xl border border-rose-200 dark:border-rose-900/60 text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/40 text-xs font-bold flex items-center gap-1.5 transition-colors cursor-pointer"
                ...
                {editingBooking.status !== "CANCELLED" && (
                  <button
                    ...
                    onClick={() => {
                      cancelBooking(
                        editingBooking.id,
                        "Cancelado desde edición de reserva"
                      );
                      onClose();
                    }}
                    className="px-3 py-2 rounded-xl border border-amber-300 dark:border-amber-800/60 text-amber-700 dark:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-950/40 text-xs font-bold flex items-center gap-1.5 transition-colors cursor-pointer"
                    title="Cancelar turno y liberar cancha"
                  >
        ...
        <div className="fixed inset-0 z-60 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="w-full max-w-sm bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 p-6 space-y-4">
            ...
            <p className="text-xs text-slate-600 dark:text-slate-300">
              ...
              del {editingBooking.date} ({editingBooking.startTime} - {editingBooking.endTime})?
            </p>
